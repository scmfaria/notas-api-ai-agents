...
- [x] T1 - Definir o modelo de tarefa e contratos de persistência
...
- [x] T2 - Implementar a lógica de serviço para criação e listagem
...
- [x] T3 - Implementar a lógica de serviço para concluir e remover
...
- [x] T4 - Expor operações de tarefas via HTTP
...
- [x] T5 - Expor operações de tarefas via CLI
...
- [x] T6 - Validar comportamento com testes e verificação de tipos
